...
export class Images extends Component{
    ...
    render(){
        ...
        <div>
            ...
            <div class="row">
                <div class="column">
                    <img src={IMG_0001} alt="Cabo Trip"/>
                    <img src={IMG_0031} alt="Cabo Trip"/>
                    <img src={IMG_0037} alt="Cabo Trip"/>
                </div>
                <div class="column">
                    <img src={IMG_0082} alt="Cabo Trip"/>
                    <img src={IMG_0120} alt="Cabo Trip"/>
                    <img src={IMG_8398} alt="Cabo Trip"/>
                    <img src={IMG_9421} alt="Cabo Trip"/>
                </div>
                <div class="column">
                    <img src={IMG_9158} alt="Cabo Trip"/>
                    <img src={IMG_9409} alt="Cabo Trip"/>
                    <img src={LRG_DSC01327} alt="Cabo Trip"/>
                </div>
            </div>
        </div>
        </SRLWrapper>
